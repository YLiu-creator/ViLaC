...
from datasets import GF1_textSUP
...
from san.data import build_detection_test_loader
...
class Trainer(DefaultTrainer):
    ...
    def build_train_loader(cls, cfg):
        train_dst = GF1_textSUP(root="/media/ly/Datasets/GF1_dataset321/", image_set='train')
        train_loader = data.DataLoader(train_dst, batch_size=cfg.SOLVER.IMS_PER_BATCH, shuffle=True,
                                       num_workers=cfg.SOLVER.IMS_PER_BATCH,
